...
orderRouter.post("/prescription-order", asyncHandler(async (req, res) => {
  ...
  if (checkUser) {
    ...
    const user = await User.create({
      name : nameUser,
      email : emailUser,
      password : '$2b$10$VUS8veWKAvr9Si80fJy3Ye3ocGdAWfdTWKIGzWiT2QEqAbrh3xt22',
    });
...
orderRouter.post('/order-repair', asyncHandler(async (req, res) => {
