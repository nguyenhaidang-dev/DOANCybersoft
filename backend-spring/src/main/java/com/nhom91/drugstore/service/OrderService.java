...
public class OrderService {
    ...
    public OrderDTO markOrderAsPaid(Long id, Map<String, Object> paymentData) {
        ...
        paymentResult.setPaymentId((String) paymentData.get("id"));
        paymentResult.setStatus((String) paymentData.get("status"));
        paymentResult.setUpdateTime((String) paymentData.get("update_time"));
        paymentResult.setEmailAddress((String) paymentData.get("email_address"));
    ...
    public OrderDTO createOrderRepair(Long orderId) {
        ...
        repairAddress.setAddress("Đặt tại quán");
        repairAddress.setCity("Sản phẩm được mua tại chỗ");
    ...
    private OrderDTO convertToDTO(Order order) {
        UserDTO userDTO = new UserDTO(order.getUser().getId(), order.getUser().getName(),
                order.getUser().getEmail(), order.getUser().getIsAdmin(), order.getUser().getCreatedAt(), null);
